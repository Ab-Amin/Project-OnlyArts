...
.then(data => {
  ...
  for (let i = 0; i < data.data.length; i++) {
    ...
    <div class="swiper-slide" data-art="${i}" data-category="${data.data[i].category_titles}">
      ...
      <div class="buttons">
        <button type="button" title="add to Favorits" class="add-to-fav" data-swiper-parallax="-300">
          <i class="fa-solid fa-heart"></i>
        </button>
        <button type="button" title="Read More..." class="read-more" data-swiper-parallax="-200">
